...
export const metadata: Metadata = createMetadata({
  ...
  description:
    "Answers to common questions about private China tours, family travel, travel advisor cooperation, and custom itinerary planning.",
  path: "/faq",
});
        ...
        <ContentContainer size="md" className="grid gap-8">
          <div>
            ...
            <h1 className="mt-5 text-4xl leading-tight font-semibold tracking-[-0.04em] md:text-6xl">
              Practical answers before we design the route.
            </h1>
