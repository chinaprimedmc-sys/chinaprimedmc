...
import { homeEditorialImages, homeNavItems } from "@/content/home/homepage";
  ...
  return (
    <main className={styles.page}>
      ...
      <SiteNavigation
        ...
        mobileCta={{ label: "Trade Enquiry", href: tradeEmailHref }}
      ...
      <section className={styles.hero} aria-labelledby="china-dmc-title" data-hero-layout="true">
        <div className={styles.heroInner}>
          ...
          <figure className={styles.heroMedia}>
            ...
            />
            <figcaption>
              Planning China face-to-face · Kuala Lumpur · 2026
            </figcaption>
          </figure>
        </div>
      </section>
      ...
      <section className={styles.proofSection} aria-labelledby="standards-title">
        <div className={styles.container}>
      ...
      <section className={styles.finalCta} aria-labelledby="trade-contact-title">
        <OptimizedImage
        ...
        <div className={styles.finalCtaInner}>
          ...
          <div className={styles.actions}>
            <a href={tradeEmailHref} className={styles.primaryAction}>
              Email the Trade Desk <ArrowUpRight aria-hidden="true" />
            </a>
            <a
              href={tradeWhatsappHref}
              target="_blank"
      ...
      <SiteFooter
        columns={[
          { title: "Explore", items: homeNavItems },
          {
            title: "Travel Trade",
            items: [
              { label: "China DMC Services", href: "/china-dmc" },
              { label: "About the Local Team", href: "/about" },
