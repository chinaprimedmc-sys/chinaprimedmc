...
type CtaVariant = "primary" | "secondary" | "outline" | "glass" | "light" | "outlineLight";
...
const variants = {
  ...
  light:
    "border border-white/75 bg-white/88 text-foreground shadow-[var(--shadow-glass)] backdrop-blur-2xl hover:bg-white",
  outlineLight:
    "border border-white/48 bg-white/10 text-white shadow-[var(--shadow-glass)] backdrop-blur-2xl hover:bg-white/18",
};
