export const buttonVariants = {
  primary:
    "border border-white/95 bg-white/88 !text-[var(--text-primary)] shadow-[var(--button-glass-shadow)] backdrop-blur-[18px] [-webkit-backdrop-filter:blur(18px)] hover:border-white hover:bg-white/96 hover:shadow-[var(--button-glass-shadow-hover)] hover:backdrop-blur-[22px]",
  secondary:
...
export const buttonBaseStyles =
  "inline-flex items-center justify-center rounded-full font-semibold tracking-[0.01em] transition-[background-color,border-color,box-shadow,backdrop-filter,opacity,transform] duration-[var(--motion-duration-micro)] ease-[var(--motion-ease-out)] hover:-translate-y-0.5 active:translate-y-0 focus-visible:ring-2 focus-visible:ring-[var(--accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-background focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 motion-reduce:transition-none motion-reduce:hover:transform-none";
