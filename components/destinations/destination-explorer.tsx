...
export function DestinationExplorer() {
  ...
  return (
    <div className="bg-[#090a09] text-white">
      <section data-hero-layout="true" className="relative isolate min-h-svh overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(5,6,5,.88)_0%,rgba(5,6,5,.62)_43%,rgba(5,6,5,.16)_78%),linear-gradient(0deg,rgba(5,6,5,.72)_0%,transparent_48%)]" />
        <div className="relative mx-auto flex min-h-svh max-w-[92rem] items-end px-5 pb-16 sm:px-6 md:items-center md:pb-0 lg:px-8">
          <div className="max-w-3xl pt-28">
            ...
            <a
              href="#interests"
              className="mt-9 inline-flex items-center gap-3 text-sm font-semibold text-white/90"
            >
          ...
          {destinationInterests.map((item, index) => {
            ...
            return (
              <button
                ...
                className="group relative isolate min-h-[17rem] overflow-hidden rounded-[1.75rem] border border-white/12 text-left transition duration-500 hover:-translate-y-1 hover:border-white/30 focus-visible:ring-2 focus-visible:ring-white/70 focus-visible:outline-none"
              >
                <Image
                  src={image.src}
                  alt={image.alt}
                ...
                <span className="absolute inset-x-0 bottom-0 p-6">
                  ...
                  <span className="mt-2 block max-w-xs text-sm leading-6 text-white/68">
                    {item.note}
                  </span>
                </span>
              </button>
      ...
      <section
        ref={regionSection}
        id="regions"
        className="min-h-svh border-y border-white/10 bg-[#10110f] py-24 md:py-28"
      >
        <div className="mx-auto max-w-[92rem] px-5 sm:px-6 lg:px-8">
          ...
          <div className="mt-9 grid gap-5 md:grid-cols-[0.7fr_1.3fr] md:items-stretch">
            <div className="flex flex-col justify-between rounded-[2rem] border border-white/10 bg-white/[0.035] p-7 md:p-9">
              <div>
                <MapPin className="size-5 text-[#c9a96e]" aria-hidden="true" />
              ...
              <p className="mt-12 text-sm leading-6 text-white/55">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {regional.map((destination) => (
                <button
                  ...
                  className="group flex min-h-40 flex-col justify-between rounded-[1.5rem] border border-white/10 bg-white/[0.04] p-6 text-left transition hover:border-white/28 hover:bg-white/[0.07]"
                >
                  <span className="text-xs font-semibold tracking-[0.17em] text-[#c9a96e] uppercase">
                    {destination.kicker}
                  </span>
                  <span>
      ...
      <section id="city-focus" className="relative min-h-svh overflow-hidden">
        ...
        />
        <div className="absolute inset-0 bg-[linear-gradient(90deg,rgba(0,0,0,.84),rgba(0,0,0,.38)_55%,rgba(0,0,0,.15)),linear-gradient(0deg,rgba(0,0,0,.75),transparent_50%)]" />
        <div className="relative mx-auto flex min-h-svh max-w-[92rem] items-end px-5 py-20 sm:px-6 md:items-center lg:px-8">
          <div className="max-w-2xl">
            <p className="text-xs font-semibold tracking-[0.2em] text-[#e3c58e] uppercase">
              03 · {current.kicker}
            </p>
            ...
            <div className="mt-7 flex flex-wrap gap-2 text-sm text-white/72">
              <span className="rounded-full border border-white/20 bg-black/20 px-4 py-2 backdrop-blur-md">
                {current.stay}
              </span>
              <span className="rounded-full border border-white/20 bg-black/20 px-4 py-2 backdrop-blur-md">
                {current.bestFor}
            ...
            <div className="mt-9 flex flex-wrap items-center gap-3">
              ...
              <button
                ...
                className="inline-flex min-h-11 items-center gap-2 rounded-full border border-white/25 bg-black/25 px-5 text-sm font-semibold backdrop-blur-lg transition hover:bg-white/15"
              >
          ...
          <div className="absolute right-5 bottom-6 flex items-center gap-3 sm:right-6 lg:right-8">
            <span className="mr-2 text-xs text-white/55">
        ...
        <div className="mt-12 grid gap-4 md:grid-cols-3">
          {[0, 1, 2].map((index) => {
            ...
            return destination ? (
              <article
                key={destination.id}
                className="relative min-h-72 overflow-hidden rounded-[1.75rem] border border-white/12"
              >
                <Image
                ...
                <button
                  ...
                  className="absolute top-4 right-4 grid size-10 place-items-center rounded-full border border-white/25 bg-black/25 backdrop-blur-lg"
              ...
              <button
                ...
                className="grid min-h-72 place-items-center rounded-[1.75rem] border border-dashed border-white/16 bg-white/[0.025] text-center text-white/40 transition hover:border-white/35 hover:text-white/70"
              >
                <span>
      ...
      <section className="border-y border-white/10 bg-[#10110f] py-24 md:py-28">
        <div className="mx-auto max-w-[92rem] px-5 sm:px-6 lg:px-8">
          <SectionIntro
      ...
      <section className="mx-auto max-w-[92rem] px-5 py-24 sm:px-6 md:py-32 lg:px-8">
        <div className="grid gap-10 rounded-[2rem] border border-white/12 bg-[radial-gradient(circle_at_top_right,rgba(201,169,110,.16),transparent_38%),rgba(255,255,255,.035)] p-7 md:grid-cols-[1fr_auto] md:items-end md:p-12">
          <div>
            <p className="text-xs font-semibold tracking-[0.2em] text-[#c9a96e] uppercase">
      ...
      <section
        ...
        className="border-t border-white/10 px-5 py-16 sm:px-6 lg:px-8"
      >
        <div className="mx-auto max-w-[92rem]">
          <h2
            id="all-destinations-title"
            className="text-xs font-semibold tracking-[0.2em] text-white/45 uppercase"
          >
...
function SectionIntro({
  ...
  return (
    <div className="max-w-3xl">
      <p className="text-xs font-semibold tracking-[0.2em] text-[#c9a96e] uppercase">{eyebrow}</p>
      <h2 className="mt-5 font-serif text-4xl leading-[1.02] md:text-6xl">{title}</h2>
      <p className="mt-5 max-w-2xl text-base leading-7 text-white/58 md:text-lg">{description}</p>
    </div>
  );
}
...
function GalleryButton({
  ...
  return (
    <button
      ...
      aria-label={label}
      onClick={onClick}
      className="grid size-11 place-items-center rounded-full border border-white/25 bg-black/25 backdrop-blur-lg transition hover:scale-105 hover:bg-white/15"
    >
      {children}
    </button>
  );
...
function JourneyPanel({
  ...
  return (
    <Link
      href={href}
      className="group relative min-h-[28rem] overflow-hidden rounded-[1.75rem] border border-white/12"
    >
      <Image
        src={image}
        alt=""
      ...
      <span className="absolute inset-x-0 bottom-0 p-7 md:p-9">
        <span className="text-xs font-semibold tracking-[0.16em] text-[#e3c58e] uppercase">
          {eyebrow}
        </span>
