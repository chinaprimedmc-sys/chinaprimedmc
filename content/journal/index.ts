...
export const journalArticles: JournalArticle[] = [
  {
    ...
    seo: {
      ...
      ogImage: destinationAsset.greatWallJinshanling,
    },
    related: {
  ...
  },
  {
    ...
    gallery: [destinationAsset.chengduPanda, destinationAsset.yangshuoYulongRiver],
    content: [
      {
        type: "heading",
  ...
  },
  {
    ...
    gallery: [destinationAsset.jiuzhaigouBrightLake, destinationAsset.huangshanClouds],
    content: [
      {
        type: "heading",
    ...
    seo: {
      ...
      ogImage: destinationAsset.jiuzhaigouBrightLake,
    },
    related: {
      destinations: ["beijing"],
      tours: ["first-china-beautifully-paced"],
