...
const destinationNav = [
  ...
  { label: "Journeys", href: "#suggested-journeys" },
...
export function DestinationTemplate({ destination }: DestinationTemplateProps) {
  ...
  return (
    <PageContainer className="pb-20 md:pb-0">
      ...
      />
      <SiteNavigation cta={{ label: "Plan This Trip", href: inquiryHref }} />
      ...
      <Section id="experiences" spacing="default" className="bg-white">
        <ContentContainer size="xl" className="grid gap-8">
          <SectionHeader
            ...
            description="Private moments that help the place become personal: food, culture, nature, family rhythm, and quieter timing."
          />
          <GridSystem columns={3}>
        ...
        <Section id="hotels" spacing="default">
          <ContentContainer size="xl" className="grid gap-8">
            <SectionHeader
              ...
              description="A few stay ideas that fit the destination's mood, comfort needs, and daily pacing."
            />
      ...
      <Section id="suggested-journeys" spacing="default" className="bg-white">
        <ContentContainer size="xl" className="grid gap-8">
          <SectionHeader
            eyebrow="Suggested journeys"
            title={`Private routes that pair well with ${destination.name}.`}
            description="Sample routes that naturally include this destination, each ready to be tailored around your travelers."
          />
          <GridSystem columns={3}>
      ...
      <Section id="gallery" spacing="default">
        <ContentContainer size="xl" className="grid gap-8">
          <SectionHeader
            ...
            description="A quick visual sense of the landscapes, atmosphere, and travel texture."
          />
      ...
      <Section id="faq" spacing="default">
        <ContentContainer size="lg" className="grid gap-8">
          <SectionHeader
            ...
            description="Short answers to the practical questions travelers ask before choosing this destination."
          />
      ...
      <Section spacing="default" className="bg-white">
        <ContentContainer size="xl">
          <CtaCard
            ...
            title={`Use ${destination.name} as a starting point, not a fixed decision.`}
            description="Send a short route brief: who is traveling, possible dates, comfort level, and what caught your eye here. We will suggest how this destination should fit."
            primary={{ label: "Send a Route Brief", href: inquiryHref }}
      ...
      <Section spacing="compact" className="bg-white">
        <ContentContainer size="xl" className="grid gap-8">
          <SectionHeader
            ...
            description="Guides and planning notes that help you understand how this destination fits into a wider China route."
          />
          <GridSystem columns={3}>
        ...
        columns={[
          ...
          },
          {
            ...
            items: [
              ...
              { label: "Search ideas", href: "/search" },
            ],
          },
          {
            title: "Related",
      ...
      />
      <FloatingCta label="Route Brief" href={inquiryHref} />
      <StickyMobileCta
        label="Brief"
        href={inquiryHref}
        showAfter={1200}
        className="right-4 bottom-[calc(env(safe-area-inset-bottom)+1rem)] scale-[0.82]"
      />
    </PageContainer>
  );
}
