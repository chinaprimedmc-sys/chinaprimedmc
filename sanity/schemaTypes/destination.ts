...
export const destinationType = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      options: {
        list: [
          { title: "North China", value: "north" },
          { title: "East China", value: "east" },
          { title: "Southwest China", value: "southwest" },
          { title: "South China", value: "south" },
          { title: "Northwest China", value: "northwest" },
        ],
      },
      validation: (rule) => rule.required(),
    }),
    ...
    defineField({ name: "kicker", title: "卡片标签", type: "string", group: "content" }),
    defineField({ name: "bestFor", title: "适合人群", type: "string", group: "content" }),
